...
class Regresssor:
    ...
    def train(
        ...
        # ------------------------------------------------------------------------- #
        if mode == "baseline":
            model, scaler, y_pred, y_test = self._train_baseline_model(
        ...
        # ------------------------------------------------------------------------- #
            ...
            all_metrics = self._feature_selection_models(
    ...
    def evaluate(
        ...
        """Evaluates the model using resampling.
    ...
    def _train_baseline_model(self, scale_data, test_size):
    ...
    def _feature_selection_models(
        ...
        if feature_selection_method == "VarianceThreshold":
            threshold = feature_selection_method.get("threshold", 0.1)
